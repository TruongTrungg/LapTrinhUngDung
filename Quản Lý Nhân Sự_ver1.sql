...
go
--Tìm theo mã KT&KL
create proc timtheomaKTKL(@maktkl nvarchar(20))
as
select*from tb_KhenThuongVaKyLuat ktkl,tb_NhanVien nv
where ktkl.MaNV=nv.MaNV and ktkl.MaKTVKL=@maktkl
go
--Tìm theo mã Bảo hiểm
create proc timtheomabh(@mabh nvarchar(20))
as
select*from tb_BaoHiem bh,tb_NhanVien nv
where bh.MaNV=nv.MaNV and bh.MaBH=@mabh
go
--tìm theo mã Nhân viên
create proc timtheomanv(@manv nvarchar(20))
as
select*from tb_PhongBan pb,tb_NhanVien nv
